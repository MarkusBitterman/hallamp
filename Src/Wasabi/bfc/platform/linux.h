...
/* NOTE: do not define None here — Qt6 uses None in its own headers
 * (qcoreevent.h) and the macro expansion breaks class parsing */
...
#define NO_INPUT_EVENTS                                                        \
  ExposureMask | StructureNotifyMask | PointerMotionMask | FocusChangeMask |   \
